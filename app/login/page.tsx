...
export const metadata: Metadata = {
  title: 'Sign In — PCX LMS',
  description: 'Sign in to the PCX Learning Management System',
};
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-white px-8 py-10 shadow-sm ring-1 ring-slate-200">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="text-xl font-bold text-slate-900">PCX Learning Management</h1>
            <p className="mt-1 text-sm text-slate-500">Sign in to access your agent portal</p>
          </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-400">
          Having trouble signing in? Contact your office administrator.
        </p>
      </div>
    </main>
  );
